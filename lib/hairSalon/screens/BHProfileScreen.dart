          ...
          child: Column(
            children: [
              Column(
                ...
                8.height,
                  Text('Rachit Gupta', style: TextStyle(color: BHAppTextColorPrimary, fontWeight: FontWeight.bold, fontSize: 16)),
                  8.height,
                  Text('rachitgupta@gmail.com', style: TextStyle(color: BHAppTextColorSecondary, fontSize: 14)),
                ],
              ),
              Container(

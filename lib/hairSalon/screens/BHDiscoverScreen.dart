            ...
            children: <Widget>[
              Row(
                ...
                children: [
                  Row(
                    children: [
                      Text('Hii', style: TextStyle(fontSize: 18, color: BHAppTextColorPrimary, fontWeight: FontWeight.bold)),
                      8.width,
                      Text('Rachit Gupta,', style: TextStyle(fontSize: 18, color: BHColorPrimary, fontWeight: FontWeight.bold)),
                    ],
                  ),
                  GestureDetector(
              ...
              Row(
                children: [
                  ...
                  Text('Bhopal, Madhya Pradesh', style: TextStyle(fontSize: 16, color: BHAppTextColorSecondary)),
                ],
              ),
              Row(
